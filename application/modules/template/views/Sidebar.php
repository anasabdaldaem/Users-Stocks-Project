                ...
                <div class="nav">
                    ...
                    <?php if($this->session->userdata('data')) {
                        ...
                        switch ($data->privilege) {
                            case 1:
                                ...
                                $link7 = base_url('main/admin/newsell');
                                $link8 = base_url('main/admin/profits');
                    ...
                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            ...
                            <a class="nav-link" href="' . $link7 . '">Sell Stocks</a>
                            <a class="nav-link" href="' . $link8 . '">User Profits</a>
                    ...
                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            ...
                            <a class="nav-link" href="' . $link2 . '">Light Sidenav</a>
                                ...
                                break;
                            case 3:
                                $link1 = base_url('main/customer/customerbalance');
