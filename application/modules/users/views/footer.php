        ...
        type :'GET'
          ...
          null,
          {
              mRender: function (data, type, row) {
                  var bindHtml = '';
                  bindHtml += '<a href="<?php echo base_url('main/admin/users/edit/')?>'+row[0]+'" title="Edit" class="update-staff-details ml-1 btn-ext-small btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>';
...
function confirm(staffname){
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = "<?php echo base_url('main/admin/users/delete/');?>" + staffname;
